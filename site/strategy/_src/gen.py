...
HL_VARIANTS = {1: ('#151A18', '#FFFFFF'), 2: ('#D0E865', '#12150A'), 3: ('#F4F6F5', '#12150A'), 4: ('#151A18', '#D0E865'), 5: ('#D0E865', '#12150A'), 6: ('#F4F6F5', '#12150A')}
...
P('post3-04', 'шаг 3 из 3', metrics('AI-система, усиливающая и ускоряющая бизнес', [
    ('3-5 недель', 'до готового продукта'),
    ('60 дней', 'на связи после завершения'),
...
PRINC = [
    ('Сначала проводим анализ, только потом определяем стоимость и критерии', 'Первый Zoom – погружение в запрос. Затем анализ, форматы сотрудничества и критерии приёмки в договоре'),
...
], kick_chip='GlobalDent, клуб стоматологов', size='mid', tsize='l'), cls='fr-lime')
...
], kick_chip='Консалтинговая компания, имя под NDA', size='mid', tsize='l'), cls='fr-milk')
...
], kick_chip='Операционный отдел, имя под NDA', size='mid', tsize='l'), cls='fr-lime')
...
S('story-06-approach-1', 'подход, 1 из 6', thesis('Сначала проводим анализ, только потом определяем стоимость и критерии', 'Первый Zoom – погружение в запрос и контекст. Затем внутренний анализ, форматы сотрудничества на выбор и чёткие критерии приёмки в договоре', 'l'), net=True)
