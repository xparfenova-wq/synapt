...
S('story-01-studio-3', 'почему мы', thesis('Объединяем компанию с AI и ускоряем прогресс', 'Мы хотим, чтобы после нас задачи решались быстрее, показатели росли, а люди занимались тем, что двигает их и бизнес вперёд. Каждая такая связка помогает эволюционировать не только компании, но и человечеству', 'm'), net=True)
S('story-01-studio-4', 'команда', team('Кто ведёт проект', [
    ('Виктор Калугин', 'технический партнёр, архитектура системы', TEAM_PH + '/витя.jpg'),
    ('Антон Орешкин', 'стратегический партнёр, продукт и развитие', TEAM_PH + '/антон.jpg'),
    ('Никита', 'project-manager студии', TEAM_PH + '/никита.jpg'),
]), cls='fr-milk')
S('story-01-studio-5', 'следующий шаг', cta('30 минут в Zoom с партнёрами студии', 'Вы рассказываете про бизнес, мы задаём вопросы и совместно определяем цели. После присылаем запись разговора и разбор: что увидели и с чего рекомендуем начать'), net=True)
...
S('story-06-approach-7', 'следующий шаг', cta('30 минут в Zoom с партнёрами студии', 'Вы рассказываете про бизнес, мы задаём вопросы и совместно определяем цели. После присылаем запись разговора и разбор: что увидели и с чего рекомендуем начать'), net=True)
